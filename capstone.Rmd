...
We need `r round(calcFreq(0.5,freq$frequency))` items in the dictionary to cover 50% and `r round(calcFreq(0.9,freq$frequency))` elements to account for 90% of the overall frequency. The total dictionary has `r round(length(freq$frequency))` unique words.
